...
{
    [TestClass]
    public class ScenarioAPositive
    {
        #region Declaraction
        ...
        {
            cartItemDetails.Add(new CartItemDetails { SKUName = "A", SKUQty = 1, IsApplyPromo = false });
            cartItemDetails.Add(new CartItemDetails { SKUName = "B", SKUQty = 1, IsApplyPromo = false });
        ...
        /// </summary>
        [TestMethod]
        public void ScenarioAPositiveTesting()
        {
            //Assert 
