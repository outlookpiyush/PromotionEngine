...
{
    [TestClass]
    public class ScenarioCPositive
    {
        #region Declaraction
        ...
        {
            cartItemDetails.Add(new CartItemDetails { SKUName = "A", SKUQty = 3, IsApplyPromo = false });
            ...
            cartItemDetails.Add(new CartItemDetails { SKUName = "D", SKUQty = 1, IsApplyPromo = false });
            expected = 280;
        }
        ...
        /// </summary>
        [TestMethod]
        public void ScenarioCPositiveTesting()
        {
            //Assert 
